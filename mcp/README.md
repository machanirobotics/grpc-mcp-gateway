...
Pre-compiled types for the `mcp.protobuf` proto package, published as libraries for Go, Python, Rust, and TypeScript. These register the MCP extension fields on `google.protobuf.ServiceOptions` and `google.protobuf.MethodOptions`.
...
| [`typescript/`](protobuf/typescript) | TypeScript | `@machanirobotics/grpc-mcp-gateway-protos` | [npm](https://www.npmjs.com/package/@machanirobotics/grpc-mcp-gateway-protos) | [README](protobuf/typescript/README.md) |
