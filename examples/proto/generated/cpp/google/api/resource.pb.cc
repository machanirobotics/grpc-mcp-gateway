...
struct ResourceReferenceDefaultTypeInternal {
  constexpr ResourceReferenceDefaultTypeInternal() : _instance(::_pbi::ConstantInitialized{}) {}
...
struct ResourceDescriptorDefaultTypeInternal {
  constexpr ResourceDescriptorDefaultTypeInternal() : _instance(::_pbi::ConstantInitialized{}) {}
...
constexpr auto ResourceDescriptor::InternalNewImpl_() {
  return ::google::protobuf::internal::MessageCreator::CopyInit(sizeof(ResourceDescriptor),
